...
use polkadot_service::{
	new_full, full_params, FullNodeHandles, PolkadotClient, ServiceComponents,
};
...
pub fn polkadot_test_new_full(
	...
	ServiceError,
> {
	let (task_manager, client, handles, network, rpc_handlers) = new_full::<polkadot_test_runtime::RuntimeApi, PolkadotTestExecutor, _>(
		config,
		collating_for,
		max_block_data_size,
